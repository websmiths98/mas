...
const WifiIcon = () => (
    <svg width="16" height="12" viewBox="0 0 16 12" fill="none">
        ...
        <path d="M4.5,7.5 Q8,5 11.5,7.5" stroke="#111" strokeWidth="1.5" fill="none" strokeLinecap="round" />
        <path d="M1.5,4.5 Q8,0.5 14.5,4.5" stroke="#111" strokeWidth="1.5" fill="none" strokeLinecap="round" />
    </svg>
);
const BatteryIcon = () => (
...
const PhoneMockup = ({ accent }: { accent: string }) => (
    <div className="relative w-full bg-white rounded-[28px] overflow-hidden"
        style={{
            border: "1.5px solid rgba(0,0,0,0.08)",
            boxShadow: "0 0 0 5px rgba(0,0,0,0.04), 0 24px 64px rgba(0,0,0,0.12), 0 8px 24px rgba(0,0,0,0.07), inset 0 1px 0 rgba(255,255,255,0.9)",
        }}
    >
        ...
        <div className="flex justify-between items-center px-5 py-2">
            <button className="w-8 h-8 flex items-center justify-center rounded-full text-gray-500">
                <svg width="10" height="16" viewBox="0 0 10 16" fill="none">
                    <path d="M8,2 L2,8 L8,14" stroke="#555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            </button>
            <div className="flex items-center gap-3">
                <button className="w-8 h-8 flex items-center justify-center rounded-full text-gray-500">
                    <svg width="16" height="18" viewBox="0 0 16 18" fill="none">
                        <path d="M8,1 L8,12 M3,6 L8,1 L13,6" stroke="#555" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M2,10 L2,15 Q2,17 4,17 L12,17 Q14,17 14,15 L14,10" stroke="#555" strokeWidth="1.8" strokeLinecap="round" fill="none" />
                    </svg>
                </button>
                <button className="w-8 h-8 flex items-center justify-center rounded-full text-gray-500">
        ...
        <div className="mx-3 mb-3">
            <div className="flex gap-2.5 mb-2.5">
                <div className="flex-1 bg-gray-50 rounded-2xl p-3 flex flex-col items-center gap-1.5 border border-gray-100">
                    <GradientPen />
            ...
            <div className="flex gap-2.5">
                <div className="flex-1 rounded-2xl overflow-hidden border border-gray-100 flex flex-col">
                    <div
                        className="flex-1 h-16"
                        style={{
                            background: "linear-gradient(135deg, #f8d7da 0%, #e2d9f3 50%, #d1ecf1 100%)",
                            backgroundSize: "200% 200%",
                        }}
                    />
                    <span className="text-[11px] font-medium text-gray-400 text-center py-1.5 bg-white">Global</span>
                </div>
                ...
                >
                    ...
                    <span
                        className="text-[11px] font-bold text-gray-800 text-center py-1.5"
                        style={{ backgroundColor: "rgba(180, 230, 60, 0.45)" }}
                    >
                        Trust
                    </span>
                </div>

                <div className="flex-1 bg-gray-50 rounded-2xl p-2.5 flex flex-col items-center justify-center gap-2.5 border border-gray-100">
                    <div className="flex items-center w-full gap-1">
                        <div className="flex-1 h-2 rounded-full overflow-hidden bg-purple-200">
                            <div className="h-full w-2/3 rounded-full bg-purple-500" />
                        </div>
                        <div className="w-4 h-4 rounded-full bg-purple-600 ring-2 ring-white shrink-0" />
                    </div>
                    <div className="flex items-center w-full gap-1">
                        <div className="w-4 h-4 rounded-full bg-gray-500 ring-2 ring-white shrink-0" />
                        <div className="flex-1 h-2 rounded-full overflow-hidden bg-gray-200">
                            <div className="h-full w-4/5 rounded-full bg-gray-500" />
                        </div>
                    </div>
                    <span className="text-[11px] font-medium text-purple-500">Excellence</span>
                </div>
            </div>
        </div>
        ...
        <main ref={containerRef} className="relative min-h-screen bg-[#f6f7f9] text-zinc-900 antialiased overflow-x-hidden [&_h1]:font-satoshi [&_h2]:font-satoshi [&_h3]:font-satoshi [&_h4]:font-satoshi [&_h5]:font-satoshi [&_h6]:font-satoshi">
            ...
            <section data-theme="light" className="overflow-hidden border-b border-zinc-200/80 bg-[#fafbfc] py-14 md:py-20">
                ...
                <div className="mx-auto mb-10 max-w-3xl px-6 text-center flex flex-col items-center">
                    <AnimatedText text="Our clients" className="text-xs font-semibold uppercase tracking-[0.2em] text-zinc-400" />
                    ...
                    >
                        ...
                        <h2 className="text-[2.75rem] md:text-[3.25rem] font-bold text-gray-900 leading-[1.1] tracking-tight mb-4">
                            Values that drive us <span className="relative inline-block">
                                <span
                                    className="absolute inset-x-0 bottom-[8%] h-[42%] rounded-sm -z-10"
                                    style={{ backgroundColor: "#bbf451", opacity: 0.65 }}
                                />
                                forward
                            </span>
                        </h2>
                    ...
                    <div className="w-full max-w-[1040px] grid grid-cols-1 lg:grid-cols-[250px_1fr_250px] gap-10 items-center relative z-10">
                        ...
                        <div className="flex justify-center relative order-first lg:order-none z-10">
                            <div className="relative w-[380px]">
                                ...
                                >
                                    <span className="text-[36px] font-black text-gray-900 leading-none">6</span>
                                    <span className="text-[11px] text-gray-400 font-medium mt-0.5">Core Values</span>
                                </motion.div>
            ...
            <section data-theme="light" className="border-t border-zinc-200/80 bg-white">
                {/* <div className="mx-auto grid max-w-6xl gap-0 md:grid-cols-2">
                    <div className="flex flex-col justify-center px-6 py-16 md:px-12 md:py-24">
                        ...
                        <a
                            ...
                            className="mt-8 inline-flex w-fit items-center text-sm font-semibold text-zinc-900 underline decoration-zinc-300 underline-offset-4 hover:decoration-zinc-900"
                        >
