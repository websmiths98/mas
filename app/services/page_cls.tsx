  ...
  return (
    <main className="relative flex h-screen w-full flex-col overflow-hidden bg-[#030608] text-[#E5E4E2]">
      ...
      <div className="relative z-10 flex flex-1 pt-32 px-10 pb-10 gap-8 overflow-hidden">
        ...
        <div className="relative flex-1 rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl bg-black/40">
          {/* Image Container */}
              ...
              >
                <div className="flex gap-2 mb-6">
                  {SERVICES[active].highlights.map((h) => (
                    <span key={h} className="px-3 py-1 border border-cyan-500/30 bg-black/80 text-[9px] font-black uppercase tracking-widest text-cyan-400 rounded-md">
                      {h}
                    </span>
                  ))}
                </div>

                <h2 className="text-7xl font-black uppercase tracking-tighter leading-[0.8] mb-8 text-white">
                  {SERVICES[active].title}
                </h2>

                {/* Sharp Text Container - Controlled Borders */}
                <div className="relative p-8 border border-white/10 rounded-2xl bg-black/90">
                  <p className="text-base font-medium leading-relaxed text-[#E5E4E2] whitespace-pre-line">
          ...
          {/* Bottom Watermark - Controlled Position */}
