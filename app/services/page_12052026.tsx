      ...
      <div className="relative z-10 flex flex-1 pt-32 px-10 pb-10 gap-8 overflow-hidden">
        ...
        <div className="flex w-[320px] flex-col gap-8 shrink-0 overflow-y-auto no-scrollbar border-r border-white/5 pr-8">
          <div className="space-y-2 shrink-0">
            ...
            <h1 className="text-4xl font-semibold tracking-tight uppercase text-white leading-none">Our<br />Services</h1>
          </div>
          ...
          <div className="flex flex-col gap-2">
            {SERVICES.map((item, i) => {
              ...
              const rowClass = cn(
                "relative flex cursor-pointer items-center gap-4 rounded-xl border p-4 transition-all duration-300",
                isActive
                  ? "translate-x-2 border-cyan-500/30 bg-white/5 shadow-[0_0_20px_rgba(6,182,212,0.05)]"
          ...
          <div className="relative h-full flex flex-col justify-end p-20">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h2 className="text-5xl font-semibold uppercase tracking-tight leading-[1.1] mb-10 text-white drop-shadow-2xl">
                ...
                <div className="relative pl-10">
                  ...
                  <p className="text-base leading-relaxed text-white/90 whitespace-pre-line tracking-wide drop-shadow-lg">
