...
export default function NetworkPage() {
  return (
    <main className="page-container-fixed bg-[#E5E4E2] text-zinc-900">
      ...
      <section className="mx-auto w-full max-w-7xl px-6 pt-24 text-left">
        <motion.h1
          ...
          className="mb-4 text-3xl md:text-4xl font-extrabold text-black tracking-tight"
        >
          Network
        </motion.h1>
        <motion.p
          ...
          className="max-w-2xl text-base text-zinc-500 md:text-lg"
        >
