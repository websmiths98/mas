...
function Globe() {
  ...
  useEffect(() => {
    ...
    let globe: ReturnType<typeof createGlobe> | null = createGlobe(canvas, {
      ...
      phi: 4.39,
      theta: -0.50,
      dark: 1, // Full dark mode base
      diffuse: 1.5,
      scale: 0.75, // Slightly larger for cinematic presence
      mapSamples: 25000, // Higher fidelity
      mapBrightness: 6.0, // More localized light
      baseColor: [0.05, 0.05, 0.05], // Midnight black/grey
      markerColor: [0.2, 0.5, 1],
      glowColor: [0.1, 0.1, 0.2], // Soft blue cinematic glow
      offset: [180, -200],
      markers,
      arcs,
...
export default function NetworkPage() {
  return (
    <main 
      className="page-container-fixed h-screen overflow-hidden text-[#E5E4E2]" 
    ...
    >
      ...
      <div className="flex h-full w-full pt-24 overflow-hidden">
        {/* Left Column: Scrollable Content */}
        <div className="w-full lg:w-[55%] h-full overflow-y-auto px-6 md:px-12 lg:px-20 pb-32 scroll-smooth">
        ...
        {/* Right Column: Globe (Fixed/Sticky) */}
        <div className="hidden lg:flex w-[45%] h-full relative items-center justify-center p-12">
          <div className="relative w-full aspect-square max-w-[600px] opacity-90 mix-blend-screen">
            <Globe />
          </div>
        </div>
      </div>
