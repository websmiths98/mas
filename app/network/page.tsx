...
function Globe() {
  ...
  useEffect(() => {
    ...
    let globe: ReturnType<typeof createGlobe> | null = createGlobe(canvas, {
      ...
      diffuse: 1.2,
      scale: 1, // Slightly larger for cinematic presence
    ...
    >
      ...
      <section className="mx-auto w-full max-w-7xl px-6 pt-24 text-left">
        <motion.h1
          ...
          className="mb-4 text-4xl md:text-5xl font-extrabold text-white tracking-tighter"
        >
          Global Network
        </motion.h1>
        <motion.p
          ...
          className="max-w-xl text-base text-zinc-500 md:text-lg italic font-light"
        >
          Visualizing the heartbeat of international logistics in real-time.
        </motion.p>
      </section>
      ...
      <section className="content-flex-center px-6 pb-12">
        <div className="relative w-full max-w-7xl h-full flex items-center justify-end">
          <div className="w-full max-w-[500px] md:max-w-[600px] lg:max-w-[800px] opacity-90 mix-blend-screen">
            <Globe />
          </div>
        </div>
      </section>
